...
`;
		...
		*/
		...
		function ContextAuditRing(props) {
			...
			(0, react.useEffect)(() => {
				if (document.getElementById("context-doctor-refresh-css") !== null) return void 0;
			...
			const refreshState = refreshView(state.state === "loading" ? "loading" : "settled", flash, elapsed, t);
					...
					children: [
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [
												...
												segment.detail.rows.slice(0, DETAIL_LIMIT).map((row) => row.path !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
													type: "button",
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														style: {
															...
															textDecorationColor: "rgba(124, 155, 255, 0.45)",
												...
												}, row.name) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								style: {
									...refreshButtonStyle,
									color: refreshState.flash ? TONE.mint : TONE.blue
								},
								children: [refreshState.flash ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CheckIcon, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									"aria-hidden": "true",
									style: refreshState.elapsed > 0 ? { display: "inline-flex" } : void 0,
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RefreshIcon, {})
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									style: refreshLabelStyle,
									children: refreshState.label
								})]
							})]
						})
					]

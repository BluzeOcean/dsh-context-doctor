window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		/** `id` of the injected refresh stylesheet; doubles as the "already injected" guard. */
		const REFRESH_STYLE_ID = "context-doctor-refresh-css";
		/** Seconds behind a timestamp, never negative; `null` reads as absent. */
		function ageSeconds(refreshedAt, now) {
			return refreshedAt === null ? 0 : Math.max(0, Math.round((now - refreshedAt) / 1e3));
		}
		/** Decide what the refresh control shows. */
		function refreshView(phase, flash, elapsed, t) {
			if (phase === "loading") return { phase, label: t("cd.refreshing"), spinning: true, flash: false, elapsed };
			if (flash) return { phase, label: t("cd.refreshed"), spinning: false, flash: true, elapsed: 0 };
			return { phase, label: t("cd.refresh"), spinning: false, flash: false, elapsed: 0 };
		}
		/** Stylesheet for the refresh control: hover/active/spin/flash/focus, scoped via data-cd-scope. */
		const REFRESH_CSS = `
...
`;
		...
		function ContextAuditRing(props) {
			...
			const styleScope = (0, react.useId)();
			...
			const refreshStart = (0, react.useRef)(null);
			const flashTimer = (0, react.useRef)(null);
			const [elapsed, setElapsed] = (0, react.useState)(0);
			const refresh = (0, react.useCallback)((forceFresh = false, settle = false) => {
				...
				fetch(url, { signal: controller.signal }).then((response) => {
					...
					if (!data.ok || data.report === null || data.report === void 0) {
			...
			const revealFile = (0, react.useCallback)((relativePath) => {
				if (report === null) return;
				const lang = document.documentElement.lang.toLowerCase().startsWith("zh") ? "zh" : "en";
				const url = `${REVEAL_API}?cwd=${encodeURIComponent(report.cwd)}&path=${encodeURIComponent(relativePath)}&lang=${lang}`;
				fetch(url).catch(() => { /* host-side reveal can fail silently; panel keeps working */ });
			}, [report]);
			(0, react.useEffect)(() => {
				refresh(false);
			...
			(0, react.useEffect)(() => {
				if (document.getElementById(REFRESH_STYLE_ID) !== null) return void 0;
					...
					children: [
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											children: [
												...
												segment.detail.rows.slice(0, DETAIL_LIMIT).map((row) => row.path !== void 0
													? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
														...
														children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
															style: { ...detailNameStyle, cursor: "pointer", color: TONE.blue, textDecoration: "underline", textDecorationColor: "rgba(124, 155, 255, 0.45)", textUnderlineOffset: 2 },
															children: row.name
														}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("footer", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: [refreshState.flash
									? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CheckIcon, {})
									: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { "aria-hidden": "true", style: refreshState.elapsed > 0 ? { display: "inline-flex" } : void 0, children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RefreshIcon, {}) }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: refreshLabelStyle, children: refreshState.label })]
							})]
						})
					]
				})]
		...
		*/
		...
		const en = {
			...
			"cd.refresh": "Refresh",
			"cd.refreshing": "Refreshing…",
			"cd.refreshed": "Updated",
